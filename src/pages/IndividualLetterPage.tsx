...
const IndividualLetterPage = () => {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen w-full parchment-bg py-20 px-4 md:px-6 overflow-y-auto">
        ...
        <div className="max-w-2xl mx-auto pt-10 relative z-10">
          <div className="bg-vintage-paper/80 backdrop-blur-sm rounded-2xl p-6 md:p-10 shadow-card border border-mint/20 opacity-0 animate-fade-in-scale">
