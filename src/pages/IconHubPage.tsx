    ...
    <PageTransition>
      <div className="page-container bg-cream flex flex-col items-center justify-center relative">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-50">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,_hsl(var(--rose-light)/0.3)_0%,_transparent_25%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,_hsl(var(--accent)/0.2)_0%,_transparent_25%)]" />
        </div>

        {/* Title */}
        <h2 
          className="font-display text-3xl md:text-4xl text-foreground mb-12 md:mb-16 
                     opacity-0 animate-slide-up text-center px-4"
        >
